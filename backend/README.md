...
## Project Structure
    ...
    ├── testapiautodatamod_115883  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_115883`
...
2. Clone this repo and `cd testapiautodatamod_115883`
